...
**     Version:             rev. 1.0, 2013-10-09
**
**     Abstract:
**         This header file implements peripheral memory map for SKEAZN84
**         processor.
**
 ...
 * @version 1.0
 * @date 2013-10-09
 * @brief Peripheral memory map for SKEAZN84
 *
 * This header file implements peripheral memory map for SKEAZN84 processor.
 */
...
#if !defined(MCU_MKE04Z4) && !defined(MCU_SKEAZN84)  /* Check if memory map has not been already included */
#define MCU_MKE04Z4
#define MCU_SKEAZN84

/* Check if another memory map has not been also included */
#if (defined(MCU_ACTIVE))
  #error SKEAZN84 memory map: There is already included another memory map. Only one memory map can be included.
...
#include "system_skeazn84.h"           /* Device specific configuration file */
...
#else /* #if !defined(MCU_MKE04Z4) && !defined(MCU_SKEAZN84) */
...
#endif  /* #if !defined(MCU_MKE04Z4) && !defined(MCU_SKEAZN84) */
